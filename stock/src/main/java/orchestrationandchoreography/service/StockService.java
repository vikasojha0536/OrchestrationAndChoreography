...
import orchestrationandchoreography.exception.StockException;
import orchestrationandchoreography.repository.StockRepository;
...
public class StockService {
    ...
    public List<StockItem> findByItemNumbers(List<String> itemNumbers, boolean matchAll) {
        ...
        if (itemList.size() == itemNumbers.size()) {
            return itemList;
        }
